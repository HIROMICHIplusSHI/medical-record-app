...
# 新規登録はデモ環境として無効化しているが（Issue #64）、招待コード制の登録ロジック自体は
# 実装済みのため、無効化を解除して検証する（無効化の挙動は account_actions_disabled_spec.rb）。
RSpec.describe 'Users::Registrations', type: :request, account_actions_enabled: true do
